...
class ChartTypeEvaluator:
    ...
    def _calculate_metrics(self, generation_chart_types: Dict[str, int], golden_chart_types: Dict[str, int]):
        ...
        try:
            ...
            try:
                ...
                print("<<<<< chart_type_calculate_metrics_recall exception >>>>>", e, self.golden_code_file)
    ...
    def _get_prefix(self):
        with open(os.environ["PROJECT_PACK_PATH"]+"/evaluator/chart_type_evaluator_prefix.py", "r") as f:
            prefix = f.read()
        return prefix
