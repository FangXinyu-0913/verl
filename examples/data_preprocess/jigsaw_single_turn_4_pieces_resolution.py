...
"""
    ...
    train_dataset = train_dataset.map(function=make_map_fn("train"), with_indices=True, num_proc=6)
    test_dataset = test_dataset.map(function=make_map_fn("test"), with_indices=True, num_proc=6)
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_four_pieces_no_shape_resolution448.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_four_pieces_no_shape_resolution448.parquet"))
