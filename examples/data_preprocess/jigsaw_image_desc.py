...
<image>首先请告诉我，你是否看到了图片，不准撒谎。其次，简要描述一下图片，50字以内。
"""
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            data = {
                ...
                "images": [os.path.join(folder_path, "rect_board.png")],
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_image_desc.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_image_desc.parquet"))
