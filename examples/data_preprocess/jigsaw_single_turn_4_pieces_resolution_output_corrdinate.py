...
**INPUT TILES:**
The following images are the individual tiles of the puzzle. Each tile is assigned a numeric Index (i.e. Tile Index).
...
"""
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_four_pieces_no_shape_resolution448_output_corrdinate.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_four_pieces_no_shape_resolution448_output_corrdinate.parquet"))
