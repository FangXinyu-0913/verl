...
Output a list of **Tile Indices** corresponding to the grid positions in the following order:
1. Top-Left
2. Top-Right
3. Bottom-Left
4. Bottom-Right
...
**Output Format:**
[Top-Left Index, Top-Right Index, Bottom-Left Index, Bottom-Right Index]
...
4. **Final Ordering:** Determine the correct index for each of the 4 positions (Top-Left, Top-Right, Bottom-Left, Bottom-Right).
...
**Final Check:**
Sky is up, grass is down. Tree trunk connects top to bottom. The order is 1, 4, 3, 2.
</Thinking>
...
<Final Answer>[Your list output here]</Final Answer>
"""
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_boardWithIndex_no_shape_resolution2048_output_index.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_boardWithIndex_no_shape_resolution2048_output_index.parquet"))
