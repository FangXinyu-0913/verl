...
if __name__ == "__main__":
    ...
    dataset = {}
    dataset['train'] = json.load(open(os.path.join(args.original_dir,'chart2code_16k_verl_train.json'),'r'))
    dataset['test'] = json.load(open(os.path.join(args.original_dir,'chart2code_16k_verl_test.json'),'r'))
