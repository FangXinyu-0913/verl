...
"""
                ...
                "prompt": [
                    {
                        ...
                        "content": (
                            ...
                            "You should use the `jigsaw_piece_edge_classifier` tool to classify the edges of each jigsaw piece, "
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_four_pieces_resolution448_w_resemble_and_edge_classification_tool.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_four_pieces_resolution448_w_resemble_and_edge_classification_tool.parquet"))
