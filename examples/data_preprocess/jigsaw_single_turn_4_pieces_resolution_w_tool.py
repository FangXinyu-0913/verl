...
"""
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_four_pieces_resolution448_w_tool.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_four_pieces_resolution448_w_tool.parquet"))
