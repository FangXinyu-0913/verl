...
"""
                ...
                "prompt": [
                    {
                        ...
                        "content": (
                            ...
                            "You should use the `jigsaw_restoration_tool` tool after step by step reasoning, "
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "train_w_tool_no_shape.parquet"))
    test_dataset.to_parquet(os.path.join(local_save_dir, "test_w_tool_no_shape.parquet"))
