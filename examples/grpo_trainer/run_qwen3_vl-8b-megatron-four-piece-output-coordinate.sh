...
train_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_four_pieces_no_shape_resolution448_output_corrdinate.parquet'
test_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_four_pieces_no_shape_resolution448_output_corrdinate.parquet'
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_four_pieces_no_shape_from_scratch_output_coordinate' \
