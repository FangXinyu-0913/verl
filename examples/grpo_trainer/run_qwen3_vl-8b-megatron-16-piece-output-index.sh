...
train_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_16_pieces_no_shape_resolution448_w_edge_tool.parquet'
test_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_16_pieces_no_shape_resolution448_w_edge_tool.parquet'
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.project_name='verl_grpo_jigsaw_16_pieces' \
    trainer.experiment_name='qwen3_vl_8b_megatron_16_pieces_no_ShapeAnalysis_from_scratch_completely_output_index' \
