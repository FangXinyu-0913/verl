...
train_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_boardWithIndex_no_shape_resolution2048_output_index.parquet'
test_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_boardWithIndex_no_shape_resolution2048_output_index.parquet'
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_boardWithIndex_no_shape_from_scratch_output_index' \
