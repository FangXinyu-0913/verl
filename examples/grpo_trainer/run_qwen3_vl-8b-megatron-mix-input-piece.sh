...
HF_MODEL_PATH="/mnt/shared-storage-user/fangxinyu/jigsaw_project/LLaMA-Factory/jigsaw_puzzle/result/qwen3vl-8b/full/vision_only_2_task/checkpoint-2000"
...
train_path='/mnt/shared-storage-user/mllm/fangxinyu/jigsaw/train_data_for_verl/train_3KindsMix_pieces_resolution448.parquet'
test_path='/mnt/shared-storage-user/mllm/fangxinyu/jigsaw/train_data_for_verl/test_3KindsMix_pieces_resolution448.parquet'
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.project_name='verl_grpo_jigsaw_Mix3Kinds_input_piece' \
    trainer.experiment_name='qwen3_vl_8b_afterSFT2kiter_single_turn_without_shape' \
