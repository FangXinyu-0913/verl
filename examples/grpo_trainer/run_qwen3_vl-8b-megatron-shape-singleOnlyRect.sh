...
train_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_only_shape_analysis_single_piece_4krect_1024resolution.parquet'
test_path='/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_only_shape_analysis_single_piece_4krect_1024resolution.parquet'
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_shape_single_only_rect_1024resolution_4k_new_prompt_for_test' \
