...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_w_tool_no_shape_analysis_with_image_feedback' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.val_before_train=False \
    trainer.test_freq=20 \
    data.train_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_w_tool_no_shape.parquet \
    data.val_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_w_tool_no_shape.parquet \
    actor_rollout_ref.rollout.agent.default_agent_loop=tool_agent \
    actor_rollout_ref.rollout.multi_turn.tool_config_path="/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/verl/examples/sglang_multiturn/config/tool_config/jigsaw_restoration_tool_config.yaml" \
