...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.ref.megatron.virtual_pipeline_model_parallel_size=1 \
    ...
    trainer.project_name='verl_grpo_jigsaw_4*4' \
    trainer.experiment_name='qwen3_vl_8b_megatron_w_edge_classification_tool_16_pieces_NoLimitForToolCall' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=60 \
    trainer.val_before_train=False \
    trainer.test_freq=10 \
    data.train_files=/mnt/shared-storage-user/mllm/fangxinyu/jigsaw/train_data_for_verl/train_16_pieces_no_shape_resolution448_w_edge_tool.parquet \
    data.val_files=/mnt/shared-storage-user/mllm/fangxinyu/jigsaw/train_data_for_verl/test_16_pieces_no_shape_resolution448_w_edge_tool.parquet \
    actor_rollout_ref.rollout.agent.default_agent_loop=tool_agent \
    actor_rollout_ref.rollout.multi_turn.tool_config_path="/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/verl/examples/sglang_multiturn/config/tool_config/jigsaw_edge_classification_tool_config.yaml" \
