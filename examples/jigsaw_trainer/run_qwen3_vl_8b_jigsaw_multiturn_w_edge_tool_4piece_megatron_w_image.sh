...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_w_edge_classification_tool_four_pieces' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=50 \
    trainer.val_before_train=False \
    trainer.test_freq=10 \
    data.train_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_four_pieces_resolution448_w_tool.parquet \
    data.val_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_four_pieces_resolution448_w_tool.parquet \
