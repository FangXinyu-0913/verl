...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_w_resemble_tool_four_pieces' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=50 \
    trainer.val_before_train=False \
    trainer.test_freq=10 \
    data.train_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_four_pieces_resolution448_w_resemble_tool.parquet \
    data.val_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_four_pieces_resolution448_w_resemble_tool.parquet \
    actor_rollout_ref.rollout.agent.default_agent_loop=tool_agent \
    actor_rollout_ref.rollout.multi_turn.tool_config_path="/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/verl/examples/sglang_multiturn/config/tool_config/jigsaw_restoration_simple_tool_config.yaml" \
