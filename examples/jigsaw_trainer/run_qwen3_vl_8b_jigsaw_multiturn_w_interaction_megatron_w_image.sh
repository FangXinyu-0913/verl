...
python3 -m verl.trainer.main_ppo \
    ...
    --config-name='jigsaw_multiturn_megatron_grpo_w_interaction' \
    ...
    trainer.experiment_name='qwen3_vl_8b_megatron_w_interatcion_no_shape_analysis_with_detailed_pos_feedback_encourage_less_turn_turn_3_NEW' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=60 \
    trainer.val_before_train=False \
    trainer.test_freq=10 \
    data.train_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/train_w_iteraction_no_shape.parquet \
    data.val_files=/mnt/shared-storage-user/fangxinyu/jigsaw_project/RealJigsaw-RL/get_data/train_data/test_w_iteraction_no_shape.parquet \
    actor_rollout_ref.rollout.agent.default_agent_loop=tool_agent \
    actor_rollout_ref.rollout.multi_turn.interaction_config_path="$PROJECT_DIR/examples/jigsaw_trainer/config/interaction_config/jigsaw_interaction_config_with_image.yaml" \
